function [m x res] = track2_MAP2(frames,bdryPts,ctrlPts,sizes,Sigma_small,Sigma_big,Sigma_0,Sigma_1,dt,nofSteps,delta,nofIt,prior)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
for it = 1:nofFrames-1
  ...
  [m(:,:,it+1) x(:,:,it+1) mu dummy dummy E(:,it)] = ...
    MAP22(frames(:,:,it+1),m(:,:,it),x(:,:,it),mu,alpha,sizes,...
    Sigma_small,Sigma_big,Sigma_0,Sigma_1,dt,nofSteps,par_obs,delta,nofIt, prior);
  toc
